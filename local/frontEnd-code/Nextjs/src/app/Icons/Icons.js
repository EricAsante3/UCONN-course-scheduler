...
export function RatingIcon({ className = "w-8 h-8", fill = "#3f8f29" }) {
  return (
    <svg
      className={className}
      fill={fill}
...
export function SearchIconHeader({ className = '', fill = '#FFFFFF' }) {
  return (
    <svg
      onClick={() => window.open('https://uconn.edu/search/', '_blank')}
      className={className}
      fill={fill}
      viewBox="0 0 32 32"
      xmlns="http://www.w3.org/2000/svg"
...
export function UConnAtoZIcon({ className = '', fill = '#FFFFFF' }) {
  return (
    <svg 
      onClick={() => window.open( "https://uconn.edu/az-index/", "_blank")}
      className={className}
      fill={fill}
      viewBox="0 0 32 32"
      xmlns="http://www.w3.org/2000/svg"
