...
export default function SearchBlock() {
  ...
  return (
    <div className="mainBoxes grid grid-rows-1 grid-cols-2 rounded-2xl relative bg-foreground aspect-square min-w-xl w-xl row-span-1 col-span-1 justify-self-center text-2xl ">
