...
export default function DetailViewPopUp() {
    ...
    return (
        <>
            ...
            <div id="mainBoxes" className="rounded-2xl bg-background absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50  flex flex-col items-center justify-between h-[900px] min-h-[800px] w-[1394px] min-w-[1394px]">
