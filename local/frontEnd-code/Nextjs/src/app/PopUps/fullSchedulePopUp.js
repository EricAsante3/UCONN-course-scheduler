...
const MotionLoadingClassCard = motion(FullViewClassCard);
...
const cardVariants = {
  ...
  show: { 
    ...
    opacity: 1,
    transition: {
      x: { type: "spring", stiffness: 50, damping: 20 }, // slide speed
      opacity: { duration: 0.5 } // fade speed
    }
  },
};
            ...
            <div className="relative grid xl:grid-row-[270px_1124px] gap-4 p-4 h-[900px] min-h-[900px] w-[640px] xl:w-full xl:grid-cols-[270px_1124px]">
                ...
                <motion.div className="space-y-4"
                    ...
                    {classData.map((classSection, index) => {
                        return <MotionLoadingClassCard key={index} classData={classSection} variants={cardVariants}></MotionLoadingClassCard>
                        })
                    }
                </motion.div>
                ...
                <div className=" bg-navyBlue w-[620px] text-white rounded-2xl h-fit xl:w-full">
                    ...
                    <div className="h-[766px] max-h-fit flex flex-row items-center justify-center p-4 space-x-6">
